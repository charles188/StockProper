    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered">
                <div>
                    <br> <p>Showing pending password request</p>
                </div>
                ...
                <form method="POST">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="resetid" value="<?php echo $user['resetid']; ?>" >
                            <input type="hidden" name="userid" value="<?php echo $user['userid']; ?>" >
                            <input type="hidden" name="userpassword" value="<?php echo $user['password']; ?>" >
