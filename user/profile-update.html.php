                            ...
                            <div class="card-body">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                  <input type="text" class="form-control" name="bus_name" value="<?php echo $_SESSION['bus_name']; ?>" />
                                </div>
                              </div>
                              <hr>
                              <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" name="bus_type" value="<?php echo $_SESSION['bus_type']; ?>" />
                                </div>
                              </div>
                              <hr>
                              <div class="row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" name="bus_address" value="<?php echo $_SESSION['bus_address']; ?>" />
                                </div>
                              </div>
                              <hr>
                              <div class="row">
